    ...
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Produk ini dilengkapi dengan fitur deteksi orang dan pengenalan wajah
          menggunakan teknologi AI lokal dan otomatisasi rumah. Memiliki zona
          aktivitas, penyimpanan lokal, dan integrasi dengan Alexa, Google
          Assistant, serta IFTTT. Kualitas video mencapai resolusi 1080p dengan
          kemampuan night vision Starlight dan tahan cuaca bersertifikat IP65.
          Mendukung konektivitas WiFi 2.4GHz & 5GHz, sirine 100db, audio dua
          arah, panggilan darurat, enkripsi, live stream P2P yang aman, serta
          fitur pemantauan objek dan notifikasi AI. Perangkat ini juga mendukung
          banyak akses, dilengkapi dengan LED inframerah, mikrofon, speaker
          mikro, tombol reset, serta dapat berfungsi sebagai WiFi extender.
        </p>
      </div>
    </section>
  );
