...
export function CamattandanceDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      >
        <h1 className="md:text-6xl text-3xl font-semibold leading-tight text-white sm:text-4xl">
          CAM FACE ATTANDANCE <br /> JVS-FRT-T5
        </h1>
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Perangkat ini merupakan sistem pengenalan wajah berbasis chip SOC
          berkinerja tinggi dengan sistem operasi Linux. Dilengkapi kamera 2.0MP
          dengan lensa 4.3mm, mampu mengenali wajah dalam waktu kurang dari 1
          detik dengan akurasi ≥99,7%, jarak 0.3–2 meter, dan mendukung hingga
          5000 wajah. Layarnya menggunakan IPS LCD 5 inci (1280×720) dengan
          panel sentuh. Mendukung koneksi TCP/IP, Wi-Fi, USB, RS485, dan Wiegand
          Output. Perangkat dilengkapi speaker internal, LED putih, IR light,
          tombol upgrade & recovery, serta dapat dipasang di dinding. Dimensinya
          154×154×20mm, berat 730g, dengan catu daya DC12V 2A, dan dapat
          beroperasi pada suhu -20℃ hingga 60℃ dan kelembapan 10–90%.
        </p>
      </div>
    </section>
  );
