    ...
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Perangkat Vanch ini adalah pembaca RFID yang mendukung frekuensi
          865~868MHz dan 902~928MHz serta protokol ISO18000-6B/6C (EPC GEN2).
          Perangkat ini memiliki jarak baca hingga 200 cm, berjalan pada sistem
          operasi Android, dan dilengkapi dengan fungsi NFC. Umumnya digunakan
          untuk manajemen gudang (warehouse management).
        </p>
      </div>
    </section>
  );
