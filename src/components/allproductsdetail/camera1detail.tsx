    ...
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Produk ini dilengkapi dengan fitur deteksi pintar seperti pendeteksian
          orang, wajah, hewan peliharaan, dan mobil. Menggunakan teknologi AI
          lokal untuk otomatisasi rumah, mendukung zona aktivitas, serta
          penyimpanan lokal tanpa cloud. Terintegrasi dengan Alexa, Google
          Assistant, dan IFTTT. Menawarkan resolusi video 1080p dengan night
          vision starlight, tahan cuaca (IPS65), dan konektivitas 2.4Ghz & 5Ghz.
          Fitur tambahan termasuk sirine 100db, audio dua arah, panggilan
          darurat, enkripsi, live stream P2P yang aman, monitoring objek, pesan
          pemicu AI, akses multipengguna, LED inframerah, mikrofon, speaker
          mikro, tombol reset, dan fungsi sebagai WiFi extender.
        </p>
      </div>
    </section>
  );
