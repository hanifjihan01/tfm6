...
export function SmartSwitch3in1Detail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Tombol Dynamax tersedia dalam varian 1/2/3 jalur dengan tegangan kerja
          AC 96V–264V. Setiap jalur memiliki daya maksimum 300W dan tidak boleh
          menghubungkan lebih dari 10 lampu secara paralel, serta arus lonjakan
          tidak boleh melebihi 78A. Tombol ini menggunakan kabel netral dan fase
          sebagai sumber daya, dengan jarak komunikasi hingga 50 meter di area
          terbuka. Dimensi produknya adalah 86mm x 86mm x 35mm.
        </p>
      </div>
    </section>
  );
