...
export function NasStorageDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Perangkat penyimpanan dengan kapasitas minimum 12TB, mendukung
          konfigurasi RAID 0, 1, 10, 5, dan 6 menggunakan HDD SAS 6G 7.2K.
          Mendukung protokol NFS dan CIFS, dilengkapi dengan 4 port jaringan
          Ethernet 1Gb. Memiliki catu daya redundan 1+1 dan satu disk cadangan
          (tidak termasuk parity). Garansi selama 3 tahun.
        </p>
      </div>
    </section>
  );
