...
export function CardReaderDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Perangkat ini adalah reader RFID dengan frekuensi 13.56 MHz dan
          mendukung protokol ISO 14443A serta T = CL. Merek perangkat ini adalah
          MTTEK dengan model MHR0110P-UID. Dimensinya 103 x 76 x 17 mm dan
          beratnya 126 gram. Perangkat ini dapat beroperasi pada suhu -20°C
          hingga +70°C, serta dapat disimpan pada suhu -25°C hingga +85°C.
          Rentang kelembaban yang didukung mencapai 95% RH (tanpa kondensasi).
        </p>
      </div>
    </section>
  );
