...
export function LayarInteractiveLcdDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Perangkat ini memiliki layar sentuh berukuran 24 inch dan menjalankan
          sistem operasi Android, memberikan pengalaman interaktif yang modern
          dan responsif. sementara.
        </p>
      </div>
    </section>
  );
