...
export function SmartGateway2Detail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Perangkat Smart Terminal Dynamax merupakan solusi terpadu yang mampu
          mengendalikan berbagai peralatan pintar. Mendukung akses ZigBee dan
          WiFi, serta mengintegrasikan fungsi smart host, router, dan TV
          jaringan. Ditenagai prosesor dual-core 1.6GHz, dilengkapi memori 1GB
          RAM + 8GB DDR3 dan dukungan flash memory hingga 32GB. Berbasis sistem
          operasi Android 4.2.1, perangkat ini memiliki 1 port WAN, 2 port LAN,
          serta bekerja pada frekuensi 2.4GHz ZigBee. Dimensi perangkat: 189mm x
          142mm x 70.5mm.
        </p>
      </div>
    </section>
