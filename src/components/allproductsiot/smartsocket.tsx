...
export function SmartSocketDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Soket listrik Dynamax ini merupakan tipe dengan saklar, dirancang
          untuk penggunaan residensial atau umum. Memiliki standar grounding dan
          satu lubang (single hole). Terbuat dari bahan ABS tahan api, soket ini
          mendukung arus maksimal 10A dengan tegangan kerja AC85~265V pada
          frekuensi 50/60Hz, dan beban maksimum hingga 2000W. Ukurannya 86mm x
          86mm x 35mm, dan tidak memiliki sertifikasi IP rating (tahan
          air/debu).
        </p>
      </div>
    </section>
