...
export function WideAngleDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Kamera ini menggunakan image sensor T31X+4335 dan dilengkapi lensa 10x
          zoom (4.7mm–47mm). Memiliki sudut pandang wide angle sebesar D:67.6°,
          H:64.8°, V:41.2°, dan telephoto sebesar D:7.15°, H:5.8°, V:4.38°.
          Resolusi kamera mencapai 4 Megapixel. Output video menggunakan USB
          2.0, dan kamera ini ditenagai oleh adaptor DC12V (2A). Kemampuan gerak
          meliputi pan 0–355° dan tilt -30° hingga +90°, dengan kecepatan zoom
          yang menyesuaikan secara otomatis dengan fokus.
        </p>
      </div>
    </section>
  );
