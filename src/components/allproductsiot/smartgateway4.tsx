...
export function SmartGateway4Detail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Perangkat ini menggunakan daya DC12V dengan arus 2A. Ditenagai oleh
          prosesor dual-core 1.6GHz, dilengkapi dengan memori 1GB RAM dan
          penyimpanan internal 16GB DDR3. Sistem operasi yang digunakan adalah
          Android 5. Mendukung konektivitas jaringan dengan 1 port WAN dan 2
          port LAN. Perangkat ini juga mendukung komunikasi nirkabel dengan
          frekuensi 2.4GHz Zigbee.
        </p>
      </div>
    </section>
  );
