...
export function SmartGateway3Detail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Produk Dynamax ini merupakan perangkat pintar yang bekerja pada
          tegangan DC12V dengan arus 2A. Ditenagai oleh prosesor dual-core
          1.6GHz dan memori 1GB+8GB DDR3, perangkat ini mendukung sistem operasi
          Android 4.2.1 dan dapat menampung memori flash hingga 32GB. Dilengkapi
          dengan satu antarmuka WAN, dua antarmuka LAN, serta mendukung
          komunikasi nirkabel melalui frekuensi Zigbee 2.4GHz, perangkat ini
          cocok untuk berbagai aplikasi dalam sistem otomasi pintar
        </p>
      </div>
    </section>
  );
