...
export function SmartSwitchDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Tombol pintar merek Dynamax ini tersedia dalam varian 1, 2, atau 3
          jalur (way) dengan tegangan kerja AC 96V~264V dan mampu menangani
          beban hingga 300W per jalur. Dapat digunakan dengan konfigurasi kabel
          netral & hidup atau hanya kabel hidup, perangkat ini mendukung
          komunikasi nirkabel dengan jarak hingga 50 meter di area terbuka.
          Konsumsi daya dalam mode siaga sangat rendah, kurang dari 0.1W, dan
          memiliki dimensi kompak 86mm x 86mm x 35mm, menjadikannya cocok untuk
          instalasi rumah pintar yang efisien dan praktis.
        </p>
      </div>
    </section>
  );
