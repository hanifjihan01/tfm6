...
export function PortableSmart2Detail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Produk ini adalah modul komunikasi Zigbee dari merek Dynamax yang
          menggunakan USB sebagai sumber daya dan memiliki frekuensi komunikasi
          2.4G. Dengan jarak komunikasi hingga 50 meter di area terbuka,
          perangkat ini dirancang untuk digunakan bersama smart gateway guna
          menambahkan perangkat secara aman dan mudah. Dilengkapi dengan port
          USB standar, modul ini mendukung plug and play, sehingga mudah
          digunakan. Ukuran perangkat adalah 83mm x 28mm x 13mm.
        </p>
      </div>
    </section>
  );
