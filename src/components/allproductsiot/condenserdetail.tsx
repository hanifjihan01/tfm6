...
export function CondenserDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      >
        <h1 className="md:text-6xl text-3xl font-semibold leading-tight text-white sm:text-4xl">
          Condenser Microphone USB <br /> Professional Speakers Audio
        </h1>
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Mikrofon USB profesional dengan ukuran 180mm x 180mm x 45mm, berat 1,3
          kg, dan radius tangkap suara hingga 5 meter. Mikrofon ini menggunakan
          output USB, cocok untuk kebutuhan rekaman atau konferensi dengan
          kualitas tinggi.
        </p>
      </div>
    </section>
