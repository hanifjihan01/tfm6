    ...
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Produk Dynamax ini merupakan perangkat catu daya dengan spesifikasi
          tegangan AC85~265V, arus 1.25A, dan frekuensi 50/60Hz. Beban daya
          maksimalnya ≤ 300W. Dengan dimensi 86mm x 86mm x 35mm, produk ini
          cocok digunakan tidak hanya untuk smart home, tetapi juga pada sistem
          smart community, smart hotel, smart building, dan smart office.
        </p>
      </div>
    </section>
  );
