...
export function SmartMotionSensorDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Sensor gerak DynaMax adalah perangkat hemat daya dengan masa siaga
          hingga 2 tahun dan umur baterai mencapai 3 tahun. Menggunakan dua
          baterai AA (DC 3V), sensor ini mampu mendeteksi gerakan manusia secara
          real-time dalam jarak hingga 6 meter pada suhu 25ºC, serta dapat
          mengontrol perangkat pintar lainnya melalui fitur linkage control.
          Konsumsi arusnya sangat rendah, yaitu ≤ 15μA saat siaga dan ≤ 15mA
          saat alarm aktif. Dilengkapi indikator daya yang mudah dipantau,
          produk ini telah bersertifikasi ISO dan dapat disesuaikan sesuai
          kebutuhan pengguna.
        </p>
      </div>
    </section>
