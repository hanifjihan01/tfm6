...
export function PortableSmart3Detail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Lampu LED DynaMax berdaya 9W ini dirancang untuk penggunaan dalam
          ruangan, dengan voltase kerja AC160~240V dan arus 0.5A. Menghasilkan
          cahaya putih murni dengan luminous flux lebih dari 800LM, serta
          memiliki efek pencahayaan berwarna (merah, hijau, biru) secara
          bertahap. Menggunakan LED high-power dengan material bodi plastik dan
          dudukan tipe E27. Lampu ini tidak memiliki peringkat IP tahan air.
        </p>
      </div>
    </section>
  );
