...
export function SmartSirenDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Alarm dengan strobo DynaMax merupakan perangkat keamanan nirkabel yang
          dilengkapi fungsi tamper housing, yang akan mengeluarkan suara saat
          terjadi gangguan serta disertai kilatan cahaya sebagai pengingat
          cepat. Alarm ini dapat disinkronkan dengan berbagai jenis sensor dan
          dikendalikan melalui perangkat pintar seperti ponsel atau tablet.
          Dengan prinsip kerja elektro-optikal dan mode pasif, alat ini bekerja
          pada tegangan DC12V dengan konsumsi daya siaga ≤ 7mA dan arus alarm ≤
          230mA. Beroperasi pada frekuensi 2.4GHz, alarm ini cocok digunakan
          untuk aplikasi dalam ruangan dan telah tersertifikasi ISO, dengan
          merek DynaMax.
        </p>
      </div>
    </section>
