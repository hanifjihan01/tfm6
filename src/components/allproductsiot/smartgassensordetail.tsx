...
export function SmartGasSensorDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Sensor gas DynaMax menggunakan prinsip sensor fotoelektrik untuk
          mendeteksi konsentrasi asap secara real-time. Perangkat ini memiliki
          konsumsi daya rendah dan masa siaga yang sangat lama. Indikator daya
          yang jelas memudahkan pengguna memantau dan mengganti baterai tepat
          waktu. Didesain untuk mendeteksi gas alam dengan tingkat alarm pada
          konsentrasi 10%LEL ± 3%LEL dan volume alarm lebih dari 85dB pada jarak
          1 meter. Mendukung sinyal output nirkabel, berbahan plastik,
          bersertifikasi ISO, dan dapat disesuaikan. Dimensi: 140mm x 164mm x
          42mm. Daya input: AC100–240V, 0.4A, 50–60Hz.
        </p>
      </div>
    </section>
  );
