...
export function ScannerRfidDetail() {
  return (
    <section className="relative bg-accent-900 px-4 py-10 text-white sm:px-6 sm:py-12 md:py-20">
      ...
      <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-6xl md:flex-row md:items-start md:gap-10">
        ...
        <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
          Produk smart card UHF RFID reader writer dari merek Vanch ini bekerja
          pada frekuensi 865-868MHz atau 902-928MHz dan mendukung protokol
          ISO18000-6B/6C serta EPC G2. Dilengkapi antena internal dan antarmuka
          komunikasi USB, perangkat ini memiliki mode kerja baca/tulis dengan
          jarak pembacaan 10–15 cm. Menggunakan catu daya USB dan berat sekitar
          0,5 kg, produk ini cocok digunakan untuk aplikasi seperti manajemen
          gudang dan pelacakan aset, serta tersedia dengan SDK untuk C# dan C++.
        </p>
      </div>
    </section>
  );
