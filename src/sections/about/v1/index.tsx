...
export function AboutSection() {
  const { images, sectionHeading, keyPoints } = aboutSectionData;
  return (
      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[.92fr_1fr] 2xl:gap-20">
          ...
          <div className="lg:order-2" data-aos="fade-left" data-aos-delay="200">
            ...
            {aboutSectionData.visionMission && (
              <div className="mt-8 space-y-6 text-accent-900 dark:text-white">
                <div data-aos="fade-up" data-aos-delay="100">
                  <h3 className="text-xl font-bold text-primary">
                    Vision & Mission
                  </h3>
                  <p className="mt-2">
                    {aboutSectionData.visionMission.vision}
                  </p>
                </div>
                <div data-aos="fade-up" data-aos-delay="200">
                  <h3 className="text-xl font-bold text-primary"></h3>
                  <ul className="mt-2 list-disc space-y-1 pl-5"></ul>
                </div>
              </div>
            )}
          </div>
